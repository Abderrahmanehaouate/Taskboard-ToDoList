<?php
    ...
    class Users extends Controller{
        ...
        public function register(){
            ...
            // Validate Email
        if(empty($data['email'])){
            $data['email_err'] = 'Pleaae enter email';
        } else {
            //Check email
            ...
            // Validate Name
            if(empty($data['name'])){
            $data['name_err'] = 'Pleaae enter name';
        }
    
            // Validate Password
            if(empty($data['password'])){
            $data['password_err'] = 'Pleaae enter password';
            ...
            $data['confirm_password_err'] = 'Pleaae confirm password';
            } else {
